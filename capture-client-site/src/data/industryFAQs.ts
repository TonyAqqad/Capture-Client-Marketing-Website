  ...
  'restaurants': [
    {
      ...
      answer: 'Yes. The AI reads your menu, takes custom orders with modifications (no onions, extra cheese), suggests add-ons to increase ticket size, processes credit card payments securely, and provides pickup time estimates based on kitchen capacity. Orders go directly to your POS system (Toast, Square, etc.) so your kitchen gets tickets instantly without staff writing anything down.',
    },
    {
