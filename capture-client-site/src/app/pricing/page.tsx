...
export const metadata: Metadata = {
  ...
  description:
    "Transparent pricing for AI voice agents, Google Ads, and Facebook Ads management. Plans from $97/mo. No setup fees, no long-term contracts. See which package fits your business.",
  keywords: [
  ...
  openGraph: {
    title: "Pricing & Packages | AI Voice Agents | Capture Client",
    description:
      "Transparent pricing for AI voice agents and lead generation. Plans from $97/mo with no long-term contracts. No setup fees.",
  ...
  twitter: {
    ...
    description:
      "AI voice agents & lead generation from $97/mo. No setup fees, no long-term contracts.",
  },
  alternates: {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "AI Voice Agents and Lead Generation pricing packages for small businesses",
            itemListElement: [
              {
                "@type": "Product",
                position: 1,
                ...
                description:
                  "Perfect for small businesses getting started with AI automation. Includes 1 AI Voice Agent, 50 calls/month, basic lead qualification.",
                brand: {
                  "@type": "Brand",
                  name: "Capture Client",
                },
              ...
              },
              {
                ...
                name: "Growth Package",
                description:
                  "Multi-channel marketing automation for growing businesses. 2 AI Voice Agents, 200+ calls/month, Google or Facebook Ads management, full CRM integration.",
                brand: {
                  "@type": "Brand",
                  name: "Capture Client",
                },
              ...
              },
              {
                ...
                description:
                  "Complete done-for-you lead generation system. Unlimited AI agents, unlimited calls, both Google & Facebook Ads, dedicated account manager, 24/7 priority support.",
                brand: {
                  "@type": "Brand",
                  name: "Capture Client",
                },
