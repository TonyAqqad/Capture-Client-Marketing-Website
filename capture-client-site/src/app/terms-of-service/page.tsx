          ...
          <div className="max-w-4xl mx-auto prose prose-base sm:prose-lg">
            <div className="bg-white border border-gray-200 rounded-xl p-5 sm:p-6 md:p-8 lg:p-12 space-y-6 sm:space-y-8">
              <div>
                ...
                >
                  By accessing or using Capture Client's platform, services, or website
              ...
              <div>
                ...
                <ul
                  className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600"
              ...
              <div>
                ...
                <p
                  ...
                  style={{ lineHeight: "1.8" }}
                >
                  Advertising spend (Google Ads, Facebook Ads) is separate from subscription fees.
                  You are responsible for ad spend costs, which are billed directly by the
                  advertising platforms. We manage campaigns but do not control ad platform billing.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  You may cancel your subscription at any time. For month-to-month plans,
                  cancellation requires 30 days written notice. Annual plans are non-cancellable but
                  will not auto-renew if you provide notice before renewal.
                </p>
              ...
              <div>
                ...
                >
                  ...
                  limited to software, text, graphics, logos, and design) are owned by Capture
                  Client and protected by copyright, trademark, and other intellectual property
                  laws.
                </p>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Our service uses artificial intelligence (AI) technology to generate voice
                  communications. When you interact with our Voice AI agents:
                </p>
                <ul
                  className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600"
                  style={{ lineHeight: "1.8", paddingLeft: "0.5rem" }}
                >
                  ...
                  <li>
                    You may request to speak with a human representative at any time by saying
                    &quot;I want to speak to a person&quot;
                  </li>
                </ul>
                <p className="text-slate-600 leading-relaxed mt-4">
                  By using our service, you acknowledge that you are aware you may be interacting
                  with AI-generated voice technology.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  By providing your phone number and using our services, you provide your prior
                  express written consent to receive:
                </p>
                <ul
                  className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600"
                  style={{ lineHeight: "1.8", paddingLeft: "0.5rem" }}
                >
                  ...
                  <li>
                    Automated calls made using an automatic telephone dialing system (ATDS),
                    artificial intelligence, or prerecorded/artificial voices
                  </li>
                </ul>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  <strong>Consent is Optional:</strong> Consent is not required as a condition of
                  purchase or use of our services.
                </p>
                <p className="text-slate-600 leading-relaxed mb-4">
                ...
                >
                  <li>
                    Replying &quot;STOP&quot;, &quot;QUIT&quot;, &quot;END&quot;,
                    &quot;CANCEL&quot;, &quot;UNSUBSCRIBE&quot;, or &quot;OPT OUT&quot; to any text
                    message
                  </li>
                  <li>
                    Saying &quot;stop&quot;, &quot;opt out&quot;, or &quot;do not call&quot; during
                    an AI voice call
                  </li>
                  <li>Calling (865) 346-6111 and requesting to be added to our Do Not Call list</li>
                  <li>
                    Emailing team@captureclient.com with &quot;OPT OUT&quot; in the subject line
                  </li>
                </ul>
                <p className="text-slate-600 leading-relaxed mt-4">
                  <strong>Processing Time:</strong> We will honor opt-out requests within 10
                  business days as required by FCC rules effective April 11, 2025.
                </p>
                <p className="text-slate-600 leading-relaxed mt-4">
                  <strong>Do Not Call Registry:</strong> We comply with the National Do Not Call
                  Registry. If your number is registered, you should not receive marketing calls
                  from us unless you have provided express consent or we have an established
                  business relationship with you.
                </p>
                <p className="text-slate-600 leading-relaxed mt-4">
                  <strong>Calling Hours:</strong> We only make calls between 8:00 AM and 9:00 PM in
                  your local time zone, as required by the TCPA.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Calls with our AI voice agents and customer service representatives may be
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  explicitly notified at the beginning of any recorded call and given the
                  opportunity to decline recording.
                </p>
                <p className="text-slate-600 leading-relaxed">
                  By continuing a call after being notified of recording, you consent to the
                  recording of that call. If you do not wish to be recorded, please inform our AI
                  agent or representative at the beginning of the call.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  By providing your mobile phone number and opting in, you agree to receive text
                  messages from Capture Client including:
                </p>
                <ul
                  className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-slate-600"
                  style={{ lineHeight: "1.8", paddingLeft: "0.5rem" }}
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Our text messaging services comply with A2P (Application-to-Person) 10DLC
                  requirements. Our campaigns are registered with The Campaign Registry (TCR) and
                  major carriers.
                </p>
                <p className="text-slate-600 leading-relaxed mb-4">
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  ...
                  based on your mobile carrier plan.
                </p>
                <p className="text-slate-600 leading-relaxed">
                  <strong>Data Sharing:</strong> We will NOT share your mobile phone number or SMS
                  opt-in consent with any third parties for marketing purposes.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Our AI voice agents will identify themselves as automated at the beginning of
                  calls. California requires all-party consent for call recording. You will be
                  explicitly notified and asked for consent before any recording begins.
                </p>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  Effective February 1, 2026, high-risk AI systems will be disclosed on our website.
                  You will be notified before AI makes any consequential decisions affecting you,
                  and you have the right to human review of AI decisions.
                </p>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  If we collect voiceprint biometric data from Illinois residents, we will obtain
                  separate written consent before collection. You have the right to informed
                  consent, to know purpose and retention period, to deletion of voiceprint data, and
                  private right of action under the Illinois Biometric Information Privacy Act
                  (BIPA).
                </p>
                ...
                <p className="text-slate-600 leading-relaxed">
                  Florida law restricts calls to 8:00 AM - 8:00 PM (stricter than federal 8 AM - 9
                  PM requirement).
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  You may request to speak with a human representative at any time during an AI call
                  by saying: &quot;Speak to a human,&quot; &quot;Transfer to representative,&quot;
                  or &quot;I need to talk to a person.&quot;
                </p>
                ...
                <p className="text-slate-600 leading-relaxed mb-4">
                  AI agents do NOT provide medical, legal, financial, tax, or other professional
                  advice requiring licensed expertise. Information provided is for general
                ...
                <p className="text-slate-600 leading-relaxed">
                  <strong>DO NOT use AI voice agents for emergencies.</strong> For emergencies, call
                  911 or contact appropriate emergency services. AI agents cannot dispatch emergency
                  services or provide emergency assistance.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  <li>
                    We will manage campaigns to the best of our ability but cannot guarantee
                    specific results
                  </li>
                  <li>You must comply with all advertising platform policies</li>
                  <li>
                    We reserve the right to refuse ads that violate platform policies or our
                    standards
                  </li>
              ...
              <div>
                ...
                >
                  ...
                  losses, or expenses (including legal fees) arising from your use of the Services
