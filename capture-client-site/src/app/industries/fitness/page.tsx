...
export const metadata: Metadata = {
  ...
  description:
    "Stop losing 76% of fitness leads. AI answers every call, books trials, and converts members 24/7. Mindbody & Wodify integration. $69K+ recovered annually.",
  keywords: [
  ...
  openGraph: {
    title: "AI Voice Agents for Fitness Studios | Capture Client",
    description:
      "Stop losing 76% of fitness leads. AI answers every call, books trials, and converts members 24/7. $69K+ recovered annually.",
  ...
  twitter: {
    ...
    title: "AI Voice Agents for Fitness Studios | Capture Client",
    description:
      "Stop losing 76% of fitness leads. AI answers every call, books trials, and converts members 24/7.",
...
const serviceSchema = {
  ...
  description:
    "24/7 AI-powered answering service for gyms, CrossFit boxes, yoga studios, and fitness centers. Captures leads, books trials, and converts members automatically.",
  provider: {
    "@type": "Organization",
    name: "Capture Client",
