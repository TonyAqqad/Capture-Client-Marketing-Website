        ...
        <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.2 }}
              className="glass-card p-8 text-center border-2 border-red-500/50"
            >
              <div className="text-6xl mb-4">❌</div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12">
            {FSM_INTEGRATIONS.map((platform, index) => (
              <motion.div
                ...
                className="glass-card p-6 text-center hover:shadow-glow-lg transition-all"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="glass-card p-8 text-center hover:shadow-glow-lg transition-all"
              >
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <a
                  href="tel:865-346-3339"
                  className="btn-gold px-10 py-5 text-xl font-bold rounded-xl shadow-glow-gold-intense hover:scale-105 transition-all w-full sm:w-auto"
                >
                  📞 Call 865-346-3339
                </a>
                <Link
