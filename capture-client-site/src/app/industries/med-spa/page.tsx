...
export const metadata: Metadata = {
  ...
  description:
    "Stop losing high-value clients to voicemail. AI concierge answers every call with 5-star service. Boulevard & Zenoti integration. Recover $125K+ annually.",
  keywords: [
  ...
  twitter: {
    ...
    title: "AI Concierge for Med Spas | Capture Client",
    description:
      "Stop losing high-value clients to voicemail. AI concierge answers every call with 5-star service. Recover $125K+ annually.",
...
const serviceSchema = {
  ...
  description:
    "24/7 AI voice concierge that answers calls, qualifies high-value clients, and books consultations directly into Boulevard, Zenoti, and other med spa management systems.",
  areaServed: {
    "@type": "Country",
    name: "United States",
  },
