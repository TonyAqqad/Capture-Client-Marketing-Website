...
export const metadata: Metadata = {
  ...
  description:
    "Stop losing 35% of patient calls. AI answers every call, books appointments 24/7. Dentrix & Eaglesoft integration. Recover $100K+ annually in lost revenue.",
  keywords: [
  ...
  openGraph: {
    title: "AI Dental Receptionist | 24/7 Booking | Capture Client",
    description:
      "Stop losing 35% of patient calls. AI answers every call, books appointments 24/7. Recover $100K+ annually in lost revenue.",
  ...
  twitter: {
    ...
    title: "AI Dental Receptionist | 24/7 Booking | Capture Client",
    description:
      "Stop losing 35% of patient calls. AI answers every call, books appointments 24/7. Recover $100K+ annually.",
...
const serviceSchema = {
  ...
  description:
    "24/7 AI-powered answering service that books dental appointments, qualifies new patients, and integrates with dental practice management software.",
  provider: {
    "@type": "Organization",
    name: "Capture Client",
  ...
  offers: {
    "@type": "Offer",
    description:
      "AI voice agents that answer every patient call 24/7, book appointments automatically, and integrate with Dentrix, Eaglesoft, Open Dental, and other practice management systems.",
  },
};
