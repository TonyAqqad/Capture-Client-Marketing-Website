    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 sm:pt-24">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-0 right-0 bottom-0 w-1/2 bg-gradient-to-br from-slate-50 to-white transform skew-x-[-8deg] origin-top-right" />
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                <div className="h-px w-8 sm:w-12 bg-gradient-to-r from-blue-600 to-transparent" />
                <span className="text-blue-600 text-xs sm:text-sm font-bold tracking-[0.15em] sm:tracking-[0.2em] uppercase">
                  Platform Features
                </span>
              </div>

              {/* Headline with extreme weight contrast - Mobile optimized */}
              <h1 className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-[0.9] mb-6 sm:mb-8">
                <span className="font-extralight text-slate-600 block">Everything You</span>
                <span className="font-black text-slate-900 block">Need to</span>
                <span className="font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500 block">
                  Grow.
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-4 sm:gap-6">
                ...
                <a
                  ...
                  className="flex items-center gap-3 sm:gap-4 text-slate-700 hover:text-slate-900 group min-h-[56px] p-2"
                >
                  <span className="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-slate-200 flex items-center justify-center group-hover:border-blue-600 group-hover:bg-blue-50 transition-all flex-shrink-0">
                    <Phone className="w-6 h-6 sm:w-8 sm:h-8" />
                  </span>
                  <span className="text-sm sm:text-base">
                    <span className="block font-bold text-base sm:text-lg">(865) 346-6111</span>
                    <span className="text-slate-500 text-xs sm:text-sm">Talk to our team</span>
                  </span>
                </a>
              </div>
            </motion.div>
      ...
      {/* INTERACTIVE CAPABILITY SHOWCASE - Tabbed Interface */}
      <section className="relative py-16 sm:py-24 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            {/* Tab content with capability meters */}
            <AnimatePresence mode="wait">
              {activeTab === "automation" && (
                <motion.div
                  ...
                  className="bg-gradient-to-br from-white to-slate-50 rounded-2xl sm:rounded-3xl border border-slate-200 p-6 sm:p-8 md:p-12 shadow-lg"
                >
                  <h3 className="font-heading text-2xl sm:text-3xl font-black text-slate-900 mb-6 sm:mb-8">
                    Automation Capabilities
                  </h3>
                  <div className="space-y-6 sm:space-y-8">
                    <CapabilityMeter label="AI Call Handling" percentage={98} color="blue" />
                    <CapabilityMeter label="Lead Qualification" percentage={95} color="cyan" />
                    <CapabilityMeter label="Appointment Scheduling" percentage={99} color="blue" />
                    <CapabilityMeter label="Follow-up Automation" percentage={92} color="cyan" />
                  </div>
                </motion.div>
              )}
              ...
              {activeTab === "analytics" && (
                ...
                >
                  ...
                  <div className="space-y-6 sm:space-y-8">
                    <CapabilityMeter label="Real-Time Reporting" percentage={100} color="blue" />
                    <CapabilityMeter label="ROI Tracking" percentage={97} color="cyan" />
                    <CapabilityMeter label="Conversion Analytics" percentage={94} color="blue" />
                    <CapabilityMeter label="Predictive Insights" percentage={89} color="cyan" />
                  </div>
                </motion.div>
              )}
      ...
      <section className="relative py-16 sm:py-24 md:py-32">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16 mb-16 sm:mb-24 md:mb-32">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            ...
            >
              {/* Number badge */}
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-blue-50 border border-blue-200 mb-4 sm:mb-6">
                <span className="text-xl sm:text-2xl font-black text-blue-600">01</span>
              </div>

              <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 mb-3 sm:mb-4">
                AI Voice Agents
              </h2>
              <p className="text-blue-600 text-lg sm:text-xl font-bold mb-4 sm:mb-6 tracking-tight">
            ...
            >
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 300 }}
                className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white to-slate-50 border border-slate-200 p-6 sm:p-8 md:p-12 overflow-hidden shadow-lg shadow-slate-200/50"
              >
                {/* Glow effect - enhanced */}
                <div className="absolute -inset-px bg-gradient-to-r from-blue-600/30 to-cyan-500/30 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-500" />
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16 mb-16 sm:mb-24 md:mb-32">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-blue-50 border border-blue-200 mb-4 sm:mb-6">
                <span className="text-xl sm:text-2xl font-black text-blue-600">02</span>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-xl sm:rounded-2xl bg-blue-50 border border-blue-200 mb-4 sm:mb-6">
                <span className="text-xl sm:text-2xl font-black text-blue-600">03</span>
              </div>
            ...
            >
              <motion.div
                whileHover={{ scale: 1.02, y: -5 }}
                transition={{ type: "spring", stiffness: 300 }}
                className="relative rounded-2xl sm:rounded-3xl bg-gradient-to-br from-white to-slate-50 border border-slate-200 p-6 sm:p-8 overflow-hidden shadow-lg shadow-slate-200/50"
              >
                {/* Hover glow effect */}
                <div className="absolute -inset-px bg-gradient-to-r from-blue-600/30 to-cyan-500/30 rounded-3xl opacity-0 group-hover:opacity-100 blur-sm transition-opacity duration-500" />
                ...
                <div className="flex items-end justify-between gap-2 sm:gap-3 h-48 sm:h-56 md:h-64 mb-6 relative z-10">
                  {[60, 75, 65, 85, 90, 80, 95].map((height, i) => (
                    <motion.div
                      ...
                      className="flex-1 bg-gradient-to-t from-blue-600 to-cyan-500 rounded-t-lg origin-bottom cursor-pointer"
                      style={{ height: `${height}%` }}
                    />
                  ))}
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 relative z-10">
                  <div className="text-center">
                    <p className="text-blue-600 text-xl sm:text-2xl font-bold">+127%</p>
                    <p className="text-slate-500 text-xs sm:text-sm">Lead Growth</p>
                  </div>
                  <div className="text-center">
                    <p className="text-blue-600 text-xl sm:text-2xl font-bold">34.2%</p>
                    <p className="text-slate-500 text-xs sm:text-sm">Conv. Rate</p>
                  </div>
                  <div className="text-center">
                    <p className="text-blue-600 text-xl sm:text-2xl font-bold">$48K</p>
      ...
      <section className="relative py-16 sm:py-24 md:py-32 bg-white">
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16">
          <div className="text-center mb-12 sm:mb-16 md:mb-20">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-black text-slate-900 mb-4 sm:mb-6 px-4">
      ...
      <section className="relative py-16 sm:py-24 md:py-32 bg-gradient-to-b from-slate-50 to-white overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-16 relative z-10">
          ...
          <div className="relative">
            {/* Gradient fade edges */}
            <div className="absolute left-0 top-0 bottom-0 w-32 sm:w-40 bg-gradient-to-r from-white to-transparent z-10 pointer-events-none" />
            <div className="absolute right-0 top-0 bottom-0 w-32 sm:w-40 bg-gradient-to-l from-slate-50 to-transparent z-10 pointer-events-none" />
            ...
            >
              {[...Array(12)].map((_, i) => (
                <motion.div
                  ...
                  className="flex-shrink-0 w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-xl sm:rounded-2xl bg-white/70 backdrop-blur-xl border border-slate-200 flex items-center justify-center hover:border-blue-300 transition-all group relative overflow-hidden shadow-sm"
                >
                  {/* Shimmer effect */}
                  <motion.div
                  ...
                  <div className="relative z-10 w-12 h-12 sm:w-14 sm:h-14 rounded-lg bg-slate-50 flex items-center justify-center">
                    <span className="text-slate-600 text-xs sm:text-sm font-bold">API</span>
                  </div>
                </motion.div>
              ))}
            </motion.div>
      ...
      <section className="relative py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-8 lg:px-16 overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          >
            ...
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.1] font-black text-slate-900 mb-4 sm:mb-6 px-4">
              <span className="font-extralight text-slate-600 block mb-2">Ready to Experience</span>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-stretch sm:items-center px-4">
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                <a
                  href="tel:865-346-6111"
                  className="group relative px-8 sm:px-10 py-4 sm:py-5 bg-white border-2 border-slate-200 text-slate-900 font-bold text-base sm:text-lg rounded-full backdrop-blur-lg hover:bg-slate-50 hover:border-blue-300 transition-all min-h-[56px] flex items-center justify-center overflow-hidden shadow-sm"
                >
...
function SecondaryFeatureCard({ icon, title, description, color, delay, number }: SecondaryFeatureCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 border border-slate-100 translate-x-3 translate-y-3 rounded-xl sm:rounded-2xl" />
      ...
      <div className="relative bg-white/90 backdrop-blur-xl border border-slate-200 rounded-xl sm:rounded-2xl p-6 sm:p-8 h-full transition-all duration-300 group-hover:-translate-y-2 shadow-sm">
        ...
        <h3 className="font-heading text-xl sm:text-2xl font-black text-slate-900 mb-2 sm:mb-3">
          {title}
        </h3>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-slate-200 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
      </div>
    </motion.div>
  );
}
...
function SupportingFeature({ icon, title, description }: SupportingFeatureProps) {
  return (
    <motion.div
      ...
      whileInView={{ opacity: 1, y: 0 }}
      viewport={{ once: true }}
      className="group relative flex items-start gap-3 sm:gap-4 p-4 sm:p-6 rounded-lg sm:rounded-xl bg-slate-50 backdrop-blur-lg border border-slate-200 hover:border-blue-300 transition-all min-h-[72px] overflow-hidden"
    >
      {/* Glass effect */}
      ...
      {/* Bottom edge highlight */}
      <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-blue-300/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
    </motion.div>
  );
}
...
function TabButton({ label, icon, isActive, onClick }: TabButtonProps) {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className={`
        relative px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-sm sm:text-base
        transition-all duration-300 min-h-[56px] flex items-center gap-2 sm:gap-3
        ${
          isActive
...
function CapabilityMeter({ label, percentage, color }: CapabilityMeterProps) {
  const colorClasses = {
    blue: {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-3">
        <h4 className="font-heading text-base sm:text-lg font-bold text-slate-900">{label}</h4>
        <span className={`text-lg sm:text-xl font-black ${colors.text}`}>{percentage}%</span>
      </div>
      ...
      <div className="relative h-3 sm:h-4 bg-slate-100 rounded-full overflow-hidden">
        ...
        <motion.div
          ...
          className={`absolute inset-y-0 left-0 bg-gradient-to-r ${colors.gradient} rounded-full shadow-lg ${colors.glow}`}
        >
          {/* Shimmer effect */}
          <motion.div
            animate={{
