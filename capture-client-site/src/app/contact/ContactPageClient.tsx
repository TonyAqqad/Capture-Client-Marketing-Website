        ...
        <section className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-6 sm:px-8">
          <div className="container mx-auto max-w-7xl">
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl md:text-2xl text-white/60 text-center max-w-2xl mx-auto mb-12 sm:mb-16 leading-relaxed px-4"
            >
              ...
              >
                ...
                <div className="relative glass rounded-2xl p-6 sm:p-8 border border-white/10 h-full hover:border-primary/30 transition-all duration-300">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <ArrowRight className="w-5 h-5 sm:w-6 sm:h-6 text-primary group-hover:translate-x-1 transition-transform duration-300" />
                  </div>
                </div>
              </Link>
              </motion.div>
        ...
        <section className="py-16 sm:py-20 px-6 sm:px-8 relative overflow-hidden">
          ...
          <div className="container mx-auto max-w-4xl relative z-10">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="glass rounded-2xl sm:rounded-3xl p-8 sm:p-12 lg:p-16 text-center border border-white/10"
            >
