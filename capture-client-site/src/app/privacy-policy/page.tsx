        ...
        <div className="max-w-4xl mx-auto prose prose-base sm:prose-lg">
          <div className="bg-white border border-gray-200 rounded-xl p-5 sm:p-6 md:p-8 lg:p-12 space-y-6 sm:space-y-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed" style={{lineHeight: '1.8'}}>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600" style={{lineHeight: '1.8', paddingLeft: '0.5rem'}}>
            ...
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mt-4">
                To exercise voiceprint rights: Email team@captureclient.com with subject &quot;BIPA Voiceprint Request&quot; or call (865) 346-6111.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600" style={{lineHeight: '1.8', paddingLeft: '0.5rem'}}>
                ...
                <li><strong>Phone:</strong> Call (865) 346-6111 to request removal</li>
                <li><strong>Email:</strong> Email team@captureclient.com with your opt-out request</li>
              </ul>
              <p className="text-gray-600 leading-relaxed mt-4">
              ...
              <ul className="list-disc list-inside space-y-2 sm:space-y-3 text-sm sm:text-base text-gray-600" style={{lineHeight: '1.8', paddingLeft: '0.5rem'}}>
                <li><strong>Email:</strong> team@captureclient.com (Subject: &quot;Privacy Request - [Type]&quot;)</li>
                <li><strong>Phone:</strong> (865) 346-6111 (Ask for Privacy Officer)</li>
