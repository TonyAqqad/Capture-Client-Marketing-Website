...
export function HeroSkeleton() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background-dark w-full">
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="mb-6 space-y-3">
          <div className="h-12 sm:h-16 md:h-20 bg-white/10 rounded-lg mx-auto max-w-4xl animate-pulse" />
          <div className="h-12 sm:h-16 md:h-20 bg-white/10 rounded-lg mx-auto max-w-3xl animate-pulse" style={{ animationDelay: '100ms' }} />
        </div>

        {/* Subheading skeleton */}
        <div className="mb-8 space-y-2 max-w-2xl mx-auto">
          <div className="h-6 bg-white/10 rounded mx-auto animate-pulse" style={{ animationDelay: '200ms' }} />
          <div className="h-6 bg-white/10 rounded mx-auto max-w-md animate-pulse" style={{ animationDelay: '300ms' }} />
        </div>

        {/* CTA buttons skeleton */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          <div className="h-14 w-48 bg-gradient-to-r from-accent/20 to-primary/20 rounded-xl animate-pulse" />
          <div className="h-14 w-40 bg-white/5 border border-white/10 rounded-xl animate-pulse" style={{ animationDelay: '100ms' }} />
        </div>
