...
export default function LocalMarketStats({
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 sm:py-16 px-4 sm:px-6 lg:px-16 bg-gradient-to-b from-white via-slate-50 to-white relative overflow-hidden"
    >
      {/* Background Effects */}
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
          ...
          <div className="group relative">
            <div className="absolute -inset-px bg-gradient-to-br from-blue-500/10 to-cyan-500/10 rounded-2xl opacity-50 blur-lg group-hover:opacity-70 transition-opacity" />
            <div className="relative h-full p-6 sm:p-8 rounded-2xl bg-white backdrop-blur-xl border border-slate-200 shadow-lg">
              {/* Icon */}
              <div className="mb-5">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200">
              ...
              {/* Counter */}
              <div className="mb-4">
                <div className="text-4xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">
          ...
          <div className="group relative">
            ...
            <div className="relative h-full p-6 sm:p-8 rounded-2xl bg-white backdrop-blur-xl border border-slate-200 shadow-lg">
              ...
              <div className="mb-5">
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200">
                  <PhoneMissed className="w-7 h-7 text-blue-600" />
                </div>
              </div>
        ...
        <div className="mt-10 sm:mt-14 max-w-4xl mx-auto">
          <div className="relative group">
            <div className="absolute -inset-px bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-2xl opacity-50 blur-xl group-hover:opacity-70 transition-opacity" />
            <div className="relative bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-6 sm:p-8 shadow-lg">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <a
                  href="#contact"
                  className="group/btn inline-flex items-center gap-2 bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 text-white px-8 py-4 rounded-xl font-black text-base shadow-lg shadow-blue-500/25 hover:shadow-2xl hover:shadow-blue-500/40 hover:scale-105 transition-all whitespace-nowrap"
                >
