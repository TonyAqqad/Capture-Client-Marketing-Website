      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="hidden lg:block max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="relative bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-8 sm:p-10 lg:p-12">
              <div className="flex items-start gap-6">
                {/* Icon */}
                <div className="flex-shrink-0">
                  <div className="relative">
                    <div className="absolute inset-0 bg-cyan-400 rounded-2xl blur-xl opacity-40" />
                    <div className="relative flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-400/30">
                      {(() => {
                        const IconComponent = getIcon(popularIndustries[activeTab].icon);
                        return <IconComponent className="text-cyan-600 w-9 h-9" />;
                      })()}
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-sm text-slate-600">Instant lead qualification</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="flex items-center justify-center w-6 h-6 rounded-full bg-green-500/20 border border-green-500/40 shrink-0 mt-0.5">
                        <Check className="w-3.5 h-3.5 text-green-400" />
                      </div>
                      <span className="text-sm text-slate-600">Automatic appointment booking</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <div className="flex items-center justify-center w-6 h-6 rounded-full bg-green-500/20 border border-green-500/40 shrink-0 mt-0.5">
                        <Check className="w-3.5 h-3.5 text-green-400" />
                    ...
                    <div className="relative h-full bg-white/80 backdrop-blur-xl border border-slate-200 rounded-2xl p-6">
                      ...
                      <div className="mb-5">
                        <div className="relative inline-flex">
                          ...
                          <div className="relative flex items-center justify-center w-16 h-16 rounded-xl bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-400/30">
                            <IconComponent className="text-cyan-600 w-7 h-7" />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-slate-600">24/7 availability</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="flex items-center justify-center w-5 h-5 rounded-full bg-green-500/20 border border-green-500/40">
                            <Check className="w-3 h-3 text-green-400" />
                          </div>
                          <span className="text-xs text-slate-600">Lead qualification</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="flex items-center justify-center w-5 h-5 rounded-full bg-green-500/20 border border-green-500/40">
                            <Check className="w-3 h-3 text-green-400" />
                          </div>
                          <span className="text-xs text-slate-600">Auto booking</span>
                        </div>
                      </div>
                    </div>
                  </div>
