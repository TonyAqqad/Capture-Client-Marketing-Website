    ...
    >
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="text-center mb-10 sm:mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#00C9FF]/10 border border-slate-200 mb-6">
            ...
            <span
              ...
              style={{ fontWeight: 600, color: "#00C9FF" }}
            >
              Why We're Different
            </span>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative border border-slate-200 bg-white/70 backdrop-blur-xl rounded-2xl overflow-hidden shadow-sm">
            ...
            <div className="grid grid-cols-3 gap-4 p-4 sm:p-6 border-b border-slate-200">
              <div
                className="text-slate-600 text-xs sm:text-sm uppercase tracking-wider"
              ...
              <div className="text-center">
                <div
                  ...
                  style={{ backgroundColor: "#00C9FF10", borderColor: "#00C9FF" }}
                >
                  <Trophy className="w-4 h-4" style={{ color: "#00C9FF" }} />
                  <span
                    className="text-xs sm:text-sm"
                    style={{ fontWeight: 700, color: "#00C9FF" }}
                  >
                    Capture Client
                  </span>
                </div>
                ...
                >
                  ...
                  <div className="flex items-center justify-center text-center">
                    <div
                      ...
                      style={{ backgroundColor: "#00C9FF10", borderColor: "#00C9FF50" }}
                    >
                  ...
                  <div className="flex items-center justify-center text-center">
                    <div
                      className="inline-flex items-center gap-2 px-3 py-2 border rounded-lg bg-slate-50"
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className="flex items-center gap-1.5 px-2.5 py-1 border rounded"
                    style={{ backgroundColor: "#00C9FF10", borderColor: "#00C9FF50" }}
                  >
                    <CheckCircle className="w-3 h-3" style={{ color: "#00C9FF" }} />
                    <span className="text-xs" style={{ fontWeight: 600, color: "#00C9FF" }}>
                      {item.us}
                    </span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className="flex items-center gap-1.5 px-2.5 py-1 border rounded bg-slate-50"
                    style={{ borderColor: "#e2e8f0" }}
                  >
                    <X className="w-3 h-3 text-slate-400" />
                    <span className="text-xs text-slate-600" style={{ fontWeight: 400 }}>
                      {item.competitors}
                    </span>
                  </div>
                </div>
        ...
        <div className="mt-10 sm:mt-12 text-center">
          <div
            className="inline-block p-6 sm:p-8 bg-gradient-to-br from-[#00C9FF]/10 to-[#4A69E2]/10 border rounded-2xl shadow-sm"
            style={{ borderColor: "#00C9FF50" }}
          >
