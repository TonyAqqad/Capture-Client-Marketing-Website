                ...
                >
                  <Link href={`/case-studies#${caseStudy.id}`}>
                    <div className="p-8">
                      ...
                      <div className="mb-6">
                        <div
                          className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/70 backdrop-blur-xl border ${theme.border} mb-3`}
                        >
                      ...
                      <div className={`p-6 rounded-2xl ${theme.bg} border ${theme.border} mb-6`}>
                        <div className="text-sm text-slate-600 mb-2">{topResult.metric}</div>
                        <div className={`text-4xl font-bold ${theme.text} mb-2`}>
                          {topResult.improvement}
                        </div>
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-slate-600">{topResult.before}</span>
                          <ArrowRight className="w-3.5 h-3.5 text-blue-500" />
                          <span className={`font-bold ${theme.text}`}>{topResult.after}</span>
                        </div>
                      </div>

                      {/* Additional Metrics */}
                      <div className="space-y-3 mb-6">
                        {caseStudy.results.slice(0, 2).map(
                          (result, idx) =>
                            result !== topResult && (
                      ...
                      <div className="flex items-center justify-between pt-4 border-t border-slate-200">
                        ...
                        <div
                          className={`px-3 py-1 rounded-full bg-gradient-to-r ${theme.gradient} bg-opacity-20 border ${theme.border}`}
                        >
