...
export function RealEstateROICalculator() {
  ...
  useEffect(() => {
    const unsubscribe1 = currentRevenueSpring.on("change", (latest) =>
      setDisplayCurrentRevenue(Math.round(latest))
    );
    const unsubscribe2 = aiRevenueSpring.on("change", (latest) =>
      setDisplayAiRevenue(Math.round(latest))
    );
    const unsubscribe3 = additionalRevenueSpring.on("change", (latest) =>
      setDisplayAdditionalRevenue(Math.round(latest))
    );
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <GlassCard
              variant="premium"
              className="p-8 bg-white/70 backdrop-blur-xl border border-slate-200 hover:border-blue-300 transition-all duration-300"
            >
              <h3
                className="text-2xl text-slate-900 mb-6 flex items-center gap-3"
              ...
              <div className="space-y-8">
                ...
                <div>
                  <div className="flex justify-between items-center mb-3">
                    <label className="text-slate-900" style={{ fontWeight: 500 }}>
                      Monthly Leads
                    </label>
          ...
          >
            ...
            <GlassCard
              variant="premium"
              className="p-8 border-2 border-red-200 bg-gradient-to-br from-red-50 to-red-100 hover:border-red-300 hover:shadow-lg hover:shadow-red-200/50 transition-all duration-500"
            >
            ...
            <GlassCard
              variant="premium"
              className="p-8 border-2 border-green-300 bg-gradient-to-br from-green-50 to-emerald-50 hover:border-green-400 hover:shadow-lg hover:shadow-green-200/50 transition-all duration-500"
            >
              <div className="flex items-center gap-3 mb-4">
            ...
            >
              <GlassCard
                variant="premium"
                className="p-8 border-2 border-blue-300 bg-gradient-to-br from-blue-50 to-cyan-50 shadow-lg shadow-blue-200/50 hover:shadow-xl hover:shadow-blue-300/50 transition-all duration-500"
              >
                <div className="text-center">
                  <p
                    className="text-sm text-blue-600 uppercase tracking-wider mb-2"
                    style={{ fontWeight: 600 }}
                  >
                    Additional Annual Revenue
                  </p>
                  <p
                    className="text-6xl bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent mb-2"
