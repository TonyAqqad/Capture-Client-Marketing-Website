...
export default function MegaMenu() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolledClass}`}>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-1">
            {Object.entries(navigationData).map(([key, section]) => (
              ...
              >
                <button
                  className="relative px-4 py-2 text-[#F8FAFC]/80 hover:text-[#D4AF37] font-body text-sm font-medium transition-all duration-300 group flex items-center gap-1"
                  aria-haspopup="true"
