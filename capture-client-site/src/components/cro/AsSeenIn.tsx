        ...
        <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0">
          <div className="flex gap-4 sm:gap-6 min-w-max sm:min-w-0 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 pb-2">
            {technicalIntegrations.map((integration, index) => (
              ...
              >
                <div className="flex flex-col items-center gap-3 px-5 sm:px-6 py-6 bg-slate-50 border border-slate-200 rounded-xl group-hover:border-accent/40 group-hover:bg-surface/50 transition-all duration-300 min-w-[140px] sm:min-w-0 min-h-[120px] sm:min-h-[140px]">
                  {/* Icon */}
                  ...
                  <div className="text-center">
                    <p className="font-heading font-bold text-base sm:text-lg text-slate-900 mb-1 whitespace-nowrap">
                      {integration.name}
                    </p>
          ...
          <div className="flex gap-4 sm:gap-6 min-w-max sm:min-w-0 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 pb-2">
            {businessPartners.map((partner, index) => (
              <motion.div
                ...
                className="group cursor-pointer"
              >
                <div className="flex flex-col items-center gap-3 px-5 sm:px-6 py-6 bg-slate-50 border border-slate-200 rounded-xl group-hover:border-primary/40 group-hover:bg-surface/50 transition-all duration-300 min-w-[140px] sm:min-w-0 min-h-[120px] sm:min-h-[140px]">
                  {/* Icon */}
      ...
      <div className="mt-12 pt-8 border-t border-slate-200 px-4">
        <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6">
          <motion.div
            ...
            className="flex items-center gap-3 px-5 sm:px-6 py-3 sm:py-4 bg-slate-50 border border-slate-200 rounded-full hover:border-accent/30 transition-all duration-300 hover:shadow-glow min-h-[48px]"
          >
          ...
          <motion.div
            ...
            className="flex items-center gap-3 px-5 sm:px-6 py-3 sm:py-4 bg-slate-50 border border-slate-200 rounded-full hover:border-primary/30 transition-all duration-300 hover:shadow-glow-primary min-h-[48px]"
          >
            ...
            <div className="text-left">
              ...
              <span className="text-xs text-slate-500 hidden sm:block">Monitored 24/7/365</span>
            </div>
          </motion.div>
