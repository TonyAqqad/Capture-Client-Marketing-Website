      ...
      {isVisible && (
        ...
        >
          ...
          <div className="relative">
            ...
            {/* Main container */}
            <div className="relative bg-background-dark/80 backdrop-blur-2xl border-t border-surface-border/50 shadow-2xl">
              <div className="max-w-screen-xl mx-auto px-4 py-3">
                <div className="flex items-center gap-3">
                  {/* Call button - premium treatment */}
                  <a
                    href="tel:865-346-3339"
                    className="flex-1 flex items-center justify-center gap-2 bg-surface/40 hover:bg-surface/60 border border-surface-border/50 rounded-xl py-3.5 font-semibold text-foreground transition-all duration-300 backdrop-blur-sm active:scale-95 min-h-[52px]"
                  >
                  ...
                  <a
                    href="/contact"
                    className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-accent to-primary rounded-xl py-3.5 font-bold text-white shadow-lg hover:shadow-accent/20 transition-all duration-300 active:scale-95 min-h-[52px]"
                  >
