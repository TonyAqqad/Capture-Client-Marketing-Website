...
export default function ClientLogos() {
  ...
  return (
    <div className="py-8 sm:py-12 bg-surface/20 rounded-2xl border border-surface-border">
      {/* Header */}
      <div className="text-center mb-8 px-4">
        <p className="text-xs sm:text-sm uppercase tracking-widest text-foreground-muted mb-2">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 px-4 sm:px-8">
        {clients.map((client, index) => (
          <motion.div
            ...
            className="group"
          >
            <div className="bg-surface/30 border border-surface-border rounded-xl p-4 sm:p-6 text-center hover:border-accent/30 transition-all duration-300 hover:shadow-glow min-h-[140px] flex flex-col justify-center">
              ...
              {/* Company name */}
              <p className="font-bold text-xs sm:text-sm text-foreground mb-1 leading-tight">
                {client.name}
              </p>

              {/* Industry badge */}
              <p className="text-xs text-foreground-muted">{client.industry}</p>
            </div>
          </motion.div>
        ))}
      </div>
      ...
      {/* Stats row */}
      <div className="mt-8 sm:mt-10 pt-6 sm:pt-8 border-t border-surface-border px-4">
        <div className="grid grid-cols-3 gap-4 sm:gap-6 max-w-3xl mx-auto text-center">
          <div>
            ...
            <p className="text-xs sm:text-sm text-foreground-muted uppercase tracking-wide leading-tight">
              Active Clients
            </p>
          </div>
          <div>
