          ...
          <div className="flex gap-3 p-2 border border-slate-200 bg-white/70 backdrop-blur-xl rounded-xl">
            <button
              ...
              className={`flex-1 px-4 py-3 rounded-lg transition-all ${
                selectedView === "comparison" ? "text-white" : "text-slate-600 hover:text-slate-900"
              }`}
              style={{
                fontFamily: "var(--font-bricolage-grotesque)",
            ...
            <button
              ...
              className={`flex-1 px-4 py-3 rounded-lg transition-all ${
                selectedView === "savings" ? "text-white" : "text-slate-600 hover:text-slate-900"
              }`}
              style={{
                fontFamily: "var(--font-bricolage-grotesque)",
          ...
          {selectedView === "comparison" ? (
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                {/* Voice AI column */}
                <div
                  className="p-6 border-2 rounded-2xl relative overflow-hidden backdrop-blur-xl"
                  style={{
                    borderColor: "#00C9FF",
              ...
              <div className="p-8 lg:p-12 border border-slate-200 bg-white/70 backdrop-blur-xl rounded-2xl">
                ...
                <div className="mb-8">
                  ...
                  >
                    <motion.div
                      initial={{ width: 0 }}
                      animate={{
                        width: `${(VOICE_AI_ANNUAL_COST / TRADITIONAL_ANNUAL_COST) * 100}%`,
                      }}
                ...
                <div className="pt-8" style={{ borderTop: "1px solid rgb(226, 232, 240)" }}>
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(135deg, rgba(0, 201, 255, 0.08) 0%, rgba(74, 105, 226, 0.08) 100%)",
                  ...
                  >
                    ...
                    >
                      ...
                      than a traditional receptionist
                    </p>
                  </div>
                </div>
