...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-background-darker to-background-dark relative overflow-hidden">
      {/* Premium gradient border at top */}
      <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary to-transparent" />
      <div className="absolute top-0.5 left-0 right-0 h-px bg-gradient-to-r from-transparent via-accent/30 to-transparent" />

      {/* Subtle mesh gradient background - Mobile optimized blur */}
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-16 relative z-10">
        ...
        <div className="py-12 sm:py-16 lg:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-3">
              <Link href="/" className="inline-flex items-center gap-3 group relative">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-primary/10 to-accent/10 rounded-lg opacity-0 group-hover:opacity-100 blur-xl transition-opacity duration-500" />
                ...
                <span className="text-xl font-heading font-bold text-foreground relative">
                  Capture Client
                </span>
              </Link>

              <p className="mt-4 sm:mt-6 text-foreground-muted font-body text-sm leading-relaxed max-w-xs">
            ...
            <div className="lg:col-span-3">
              <h3 className="text-foreground font-heading font-semibold text-sm uppercase tracking-wider mb-6 relative inline-block">
                Services
                <span className="absolute -bottom-2 left-0 w-12 h-px bg-gradient-to-r from-primary to-accent" />
              </h3>
          ...
          <div className="mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-white/10 relative">
            ...
            <div className="absolute top-0 left-0 w-32 h-px bg-gradient-to-r from-primary to-accent" />

            <div className="max-w-2xl">
              <h3 className="text-foreground font-heading font-semibold text-base sm:text-lg mb-2 sm:mb-3">
                Stay updated with our latest insights
              </h3>
              <p className="text-foreground-muted font-body text-sm mb-4 sm:mb-6">
              ...
              <form className="flex flex-col sm:flex-row gap-3 relative group">
                ...
                <input
                  ...
                  className="flex-1 w-full min-h-[48px] px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-foreground placeholder:text-foreground-muted font-body text-base focus:outline-none focus:ring-2 focus:ring-primary focus:border-accent hover:border-white/20 transition-all duration-300"
                />
                <button
                  type="submit"
          ...
          <div className="mt-12 pt-8 border-t border-white/10 relative">
            ...
            <div className="flex flex-wrap items-center gap-8">
              <span className="text-foreground-muted font-body text-xs uppercase tracking-wider font-medium">
                Trusted Partners
              </span>
              <div className="flex flex-wrap items-center gap-6">
                <span className="text-foreground-muted font-body text-sm hover:text-accent transition-all duration-300 cursor-pointer relative group/badge">
                  Google Ads Partner
                  <span className="absolute -bottom-0.5 left-0 w-0 h-px bg-gradient-to-r from-primary to-accent group-hover/badge:w-full transition-all duration-300" />
                </span>
                <span className="text-foreground-muted font-body text-sm hover:text-accent transition-all duration-300 cursor-pointer relative group/badge">
        ...
        <div className="border-t border-white/10 py-6 sm:py-8 relative">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
            <p className="text-foreground-muted font-body text-xs sm:text-sm text-center md:text-left" suppressHydrationWarning>
            ...
            <div className="flex items-center gap-2">
              <a
                ...
                className="relative flex items-center justify-center min-w-[48px] min-h-[48px] text-foreground-muted hover:text-accent transition-all duration-300 active:scale-95 rounded-lg hover:bg-white/5 border border-transparent hover:border-white/10 group/social overflow-hidden"
                aria-label="Twitter"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5 opacity-0 group-hover/social:opacity-100 transition-opacity duration-300" />
