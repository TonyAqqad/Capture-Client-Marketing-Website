...
export function PremiumHero() {
  ...
  // Only start animating after hydration is complete
  useEffect(() => {
    if (!isClient) return;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7">
            {/* Eyebrow badge with live indicator - Mobile optimized */}
            <motion.div
            ...
            {/* Subheadline with staggered fade-in - Mobile optimized */}
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* CTA buttons with magnetic effect - Mobile optimized */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {/* Trust badges row with live stats - Mobile optimized with horizontal scroll */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      {/* Scroll indicator with enhanced design - Hidden on small mobile for space */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        animate={{ opacity: 1, y: 0 }}
