    ...
    <section className="relative overflow-hidden w-full py-20 sm:py-28 lg:py-36 bg-white">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at center, rgba(37, 99, 235, 0.08) 0%, transparent 60%)",
            filter: "blur(60px)",
          }}
        />
        {/* Subtle grid pattern */}
            ...
            <div style={isMobile ? {} : perspectiveContainer}>
              <motion.div
                style={
                  isMobile
                    ...
                    : {
                        ...transform3D,
                        rotateX: featuredTilt.rotateX,
                        rotateY: featuredTilt.rotateY,
                      }
                }
              ...
              >
                ...
                <motion.div
                  ...
                  animate={{
                    y: featuredTilt.isHovered ? -4 : 0,
                    x: featuredTilt.isHovered ? 4 : 0,
                  }}
                  transition={{ duration: 0.3 }}
                >
                  ...
                  <div style={isMobile ? {} : perspectiveContainer}>
                    <motion.div
                      style={
                        isMobile
                          ? {}
                          : { ...transform3D, rotateX: cardTilt.rotateX, rotateY: cardTilt.rotateY }
                      }
                      animate={{
                        boxShadow: cardTilt.isHovered ? cardShadow.hover : cardShadow.rest,
                      }}
                      transition={{ duration: 0.3 }}
                      {...cardTilt.handlers}
